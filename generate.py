...
class CrosswordCreator():
    ...
    def consistent(self, assignment):
        ...
        for variable in assignment:
            if assignment[variable] not in words_used:
                words_used.add(assignment[variable])
            else:
                return False
            ...
            for neighbour in self.crossword.neighbors(variable):
                if neighbour in assignment:
                    a,b = self.crossword.overlaps[variable, neighbour]
                    if assignment[variable][a] != assignment[neighbour][b]:
                        return False
        return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        for variable in self.domains[var]:
            ...
            for neighbour in self.crossword.neighbors(var) - assignment:
                if variable in self.domains[neighbour]:
                    n[variable] += 1
